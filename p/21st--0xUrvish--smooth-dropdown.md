<!-- Smooth Dropdown · @0xUrvish · https://21st.dev/@0xUrvish/components/smooth-dropdown
...
```tsx
components/ui/smooth-dropdown.tsx
"use client";
...
```bash
npm install @hugeicons/core-free-icons @hugeicons/react clsx motion react-use-measure tailwind-merge
```
