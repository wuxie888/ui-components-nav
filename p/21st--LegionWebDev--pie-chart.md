<!-- Pie Chart · @LegionWebDev · https://21st.dev/@LegionWebDev/components/pie-chart
...
```tsx
components/ui/echarts-pie-chart.tsx
"use client";
...
```bash
npx shadcn@latest add badge card echarts-chart echarts-legend echarts-tooltip
```
