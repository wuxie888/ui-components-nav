<!-- Activity Dropdown · @Mazyar kawa · https://21st.dev/@Mazyar kawa/components/activity-dropdown
     license: MIT · category: dropdown
     An animated activity dropdown menu with smooth transitions and icon indicators. -->
...
```tsx
components/ui/activity-dropdown.tsx
"use client"
