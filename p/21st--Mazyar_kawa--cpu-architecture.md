<!-- CPU Architecture · @Mazyar kawa · https://21st.dev/@Mazyar kawa/components/cpu-architecture
     license: MIT · category: data-visualization
     An animated CPU architecture diagram with flowing data paths and SVG animations. -->
