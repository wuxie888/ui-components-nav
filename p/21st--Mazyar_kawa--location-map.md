<!-- Location Map · @Mazyar kawa · https://21st.dev/@Mazyar kawa/components/location-map
     license: MIT · category: map
     An animated location map component with pulsing markers and smooth transitions. -->
