<!-- Logo Loop · @Mazyar kawa · https://21st.dev/@Mazyar kawa/components/logo-loop
     license: no-license · category: marquee
     A looping logo marquee that scrolls brand or tech-stack logos horizontally or vertically with fading edges, hover deceleration, and scale-on-hover effects. -->
