<!-- 8-bit Menubar · @OrcDev · https://21st.dev/@OrcDev/components/8bit-menubar
     license: MIT · category: dropdown
     Pixel-art horizontal menubar from 8bitcn.com — retro pixel border on top-level items and submenus, with checkbox/radio items and submenus. Built on Radix Menubar (clean source). -->
...
```bash
npm install @radix-ui/react-menubar class-variance-authority lucide-react tailwindcss tw-animate-css
```
