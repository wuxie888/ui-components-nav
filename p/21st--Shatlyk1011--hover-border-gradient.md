<!-- Hover Border Gradient · @Shatlyk1011 · https://21st.dev/@Shatlyk1011/components/hover-border-gradient
...
```tsx
components/emerald-ui-components/buttons/hover-border-gradient.tsx
'use client'
