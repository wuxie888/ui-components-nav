<!-- Auralis · @amanshakya307 · https://21st.dev/@amanshakya307/components/auralis
     license: no-license · category: hero
     A WebGL animated background with layered simplex noise, glowing light, vignette, and film grain for a dramatic ambient hero effect. -->
...
```tsx
components/auralis/auralis.tsx
"use client";
