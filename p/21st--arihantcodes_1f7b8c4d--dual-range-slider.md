<!-- Dual Range Slider · @arihantcodes_1f7b8c4d · https://21st.dev/@arihantcodes_1f7b8c4d/components/dual-range-slider
...
```tsx
components/ui/dual-range-slider-dependecies.tsx
"use client";
