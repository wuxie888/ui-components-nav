<!-- Large Name Footer · @arihantcodes_1f7b8c4d · https://21st.dev/@arihantcodes_1f7b8c4d/components/large-name-footer
...
```bash
npx shadcn@latest add button icon-dependencies icons
```
