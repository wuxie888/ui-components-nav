<!-- Multiple Selector · @arihantcodes_1f7b8c4d · https://21st.dev/@arihantcodes_1f7b8c4d/components/multiple-selector
     license: unspecified · category: form
     Here is Multiple Selector component -->
...
```tsx
components/ui/multiple-selector-dependencies.tsx
"use client";
...
```bash
npx shadcn@latest add badge command inline-code
```
