<!-- Responsive Modal · @arihantcodes_1f7b8c4d · https://21st.dev/@arihantcodes_1f7b8c4d/components/responsive-modal
...
```tsx
components/ui/responsive-modal-demo.tsx
...
```bash
npx shadcn@latest add button responsive-modal-dependencies
```
