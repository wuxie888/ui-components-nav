<!-- Type Testimonial · @ayushmxxn · https://21st.dev/@ayushmxxn/components/type-testimonial
     license: MIT · category: testimonials
     Hover over an avatar to reveal a testimonial with a smooth typewriter animation and optional voice playback. -->
...
import { TypewriterTestimonial } from "@/components/ui/type-testimonial";

// ONLY DEFAULT EXPORT WILL BE TREATED AS A DEMO
export default function DemoOne() {
  return <TypewriterTestimonial/>;
}
```
