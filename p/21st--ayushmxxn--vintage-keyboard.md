<!-- Vintage Keyboard · @ayushmxxn · https://21st.dev/@ayushmxxn/components/vintage-keyboard
     license: MIT · category: kbd
     A nostalgic vintage keyboard with interactive keypress animations and a realistic retro design -->
...
```tsx
components/serenity/vintage-keyboard.tsx
"use client";
...
demo.tsx
import { Component } from "@/components/ui/vintage-keyboard";
