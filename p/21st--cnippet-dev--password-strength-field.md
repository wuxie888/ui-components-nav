<!-- Password Strength Field · @cnippet-dev · https://21st.dev/@cnippet-dev/components/password-strength-field
     license: no-license · category: form
     A password input field with a live strength meter and label that reflects how strong the entered password is. -->
