<!-- Segmented Control Tabs · @cnippet-dev · https://21st.dev/@cnippet-dev/components/segmented-control-tabs
     license: MIT · category: stat
     A compact segmented-control style tab switcher with icons that toggles between daily, weekly, monthly and yearly stat cards. -->
...
demo.tsx
import Pattern from "@/components/ui/segmented-control-tabs";
