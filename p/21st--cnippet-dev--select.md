<!-- Select · @cnippet-dev · https://21st.dev/@cnippet-dev/components/select
     license: MIT · category: select
     A styled select dropdown for choosing a single option from a list, with a trigger, searchable popup, scroll arrows, grouping, and keyboard navigation. -->
