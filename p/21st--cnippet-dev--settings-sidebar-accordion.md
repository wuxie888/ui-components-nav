<!-- Settings Sidebar Accordion · @cnippet-dev · https://21st.dev/@cnippet-dev/components/settings-sidebar-accordion
...
demo.tsx
import Pattern from "@/components/ui/settings-sidebar-accordion";
...
```bash
npx shadcn@latest add accordion accordion?api_key=21st_sk_5356a638ce7b27c9e1337a2db58cf9cf8bd3e395819fe545408f2a17d3ef2068&publisher_install_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwdXJwb3NlIjoicHVibGlzaGVyLXJlZ2lzdHJ5LWluc3RhbGwiLCJpYXQiOjE3ODcxMTY2MDcsImV4cCI6MTc4NzExNzIwN30.gO_SvYVlSiqaIo6EfCxGientDkL9Z728y0RhrwNAlLs
```
