<!-- Tabs with Icons · @cnippet-dev · https://21st.dev/@cnippet-dev/components/tabs-with-icons
     license: no-license · category: dashboard
     A tabs component with icon-labeled triggers switching between card panels for dashboard overview, analytics, and settings views. -->
...
demo.tsx
import Pattern from "@/components/ui/tabs-with-icons";
