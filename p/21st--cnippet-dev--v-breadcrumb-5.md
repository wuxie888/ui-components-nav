<!-- Breadcrumb with Icons · @cnippet-dev · https://21st.dev/@cnippet-dev/components/v-breadcrumb-5
...
```tsx
components/ui/v-breadcrumb-5.tsx
...
demo.tsx
import Pattern from "@/components/ui/v-breadcrumb-5";
