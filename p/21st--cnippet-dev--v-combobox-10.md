<!-- Country Combobox · @cnippet-dev · https://21st.dev/@cnippet-dev/components/v-combobox-10
     license: no-license · category: search
     A searchable country combobox with an outline trigger button, popup search input with icon, empty state, and scrollable list. -->
...
```tsx
components/ui/v-combobox-10.tsx
"use client";
...
demo.tsx
import CountryCombobox from "@/components/ui/v-combobox-10";
