<!-- Support Request Fieldset · @cnippet-dev · https://21st.dev/@cnippet-dev/components/v-fieldset-9
     license: no-license · category: form
     A grouped support-request form fieldset with a legend, labeled subject, description and email fields, and helper text. -->
...
```tsx
components/ui/v-fieldset-9.tsx
import {
  Field,
  FieldDescription,
  FieldLabel,
...
demo.tsx
import Pattern from "@/components/ui/v-fieldset-9";
...
```bash
npx shadcn@latest add fieldset input textarea
```
