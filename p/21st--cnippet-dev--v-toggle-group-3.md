<!-- Outline Toggle Group · @cnippet-dev · https://21st.dev/@cnippet-dev/components/v-toggle-group-3
...
```tsx
components/ui/v-toggle-group-3.tsx
...
demo.tsx
import ToggleGroupOutline from "@/components/ui/v-toggle-group-3";
