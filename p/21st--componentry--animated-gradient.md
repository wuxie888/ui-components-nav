<!-- Animated Gradient · @componentry · https://21st.dev/@componentry/components/animated-gradient
     license: no-license · category: hero
     A full-cover WebGL animated gradient background with configurable presets, noise overlay, and swirl distortion for hero sections and cards. -->
...
components/ui/webgl-error-boundary.tsx
"use client";
