<!-- Collapsible Banner · @ddoemonn · https://21st.dev/@ddoemonn/components/collapsible-banner
     license: MIT · category: notification
     A dismissible notice banner that folds its details away with a spring animation, with a controllable open/folded/dismissed state and an accessible expand/collapse toggle. -->
...
```tsx
components/ui/collapsible-banner.tsx
"use client";
...
import { CollapsibleBanner } from "@/components/ui/collapsible-banner";
