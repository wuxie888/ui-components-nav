<!-- Feedback Widget · @dev.shejanmahamud · https://21st.dev/@dev.shejanmahamud/components/feedback-widget
     license: unspecified · category: textarea
     A feedback widget with emoji ratings and a text area inspired from Vercel. -->
...
```bash
npm install @radix-ui/react-toggle-group motion react-markdown
```
