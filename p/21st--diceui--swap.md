<!-- Swap · @diceui · https://21st.dev/@diceui/components/swap
     license: MIT · category: toggle
     A component that swaps between two states with click or hover activation and fade, rotate, flip, or scale transitions. -->
