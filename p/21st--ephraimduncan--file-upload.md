<!-- File Upload · @ephraimduncan · https://21st.dev/@ephraimduncan/components/file-upload
     license: unspecified · category: upload-download
     here is minimalistic file upload component -->
...
import FileUpload01 from "@/components/ui/file-upload";
...
```bash
npm install @radix-ui/react-label @radix-ui/react-select @radix-ui/react-tooltip class-variance-authority clsx lucide-react tailwind-merge
```
