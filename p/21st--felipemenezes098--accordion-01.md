<!-- Basic Accordion · @felipemenezes098 · https://21st.dev/@felipemenezes098/components/accordion-01
     license: agpl-3.0 · category: faq
     A vertically stacked set of collapsible sections with chevron indicators and smooth expand/collapse animation, ideal for FAQs and disclosure content. -->
...
demo.tsx
import Accordion01 from "@/components/ui/accordion-01";
