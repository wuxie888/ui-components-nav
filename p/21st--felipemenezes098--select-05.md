<!-- Select With Object · @felipemenezes098 · https://21st.dev/@felipemenezes098/components/select-05
     license: no-license · category: form
     A select dropdown whose options each show a bold label with a muted description sub-line, and whose trigger displays the full two-line item when selected. -->
...
demo.tsx
import { Select05 } from "@/components/ui/select-05";
