<!-- Stories Carousel · @haydenbleasel · https://21st.dev/@haydenbleasel/components/stories-carousel
     license: unspecified · category: gallery
     Here is Stories Carousel component -->
...
```bash
npx shadcn@latest add avatar carousel
```
