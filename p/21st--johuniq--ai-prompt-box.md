<!-- AI Prompt Box · @johuniq · https://21st.dev/@johuniq/components/ai-prompt-box
     license: MIT · category: upload-download
     An animated AI prompt input with expanding textarea, keyboard shortcuts, model selector, and file attachments. -->
...
```bash
npm install @radix-ui/react-dialog @radix-ui/react-tooltip framer-motion lucide-react motion
```
