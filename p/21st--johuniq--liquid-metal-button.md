<!-- Liquid Metal Button · @johuniq · https://21st.dev/@johuniq/components/liquid-metal-button
     license: MIT · category: border
     A button with liquid metal animation, metallic glowing borders, and fluid hover effects. -->
...
```bash
npm install @paper-design/shaders clsx lucide-react tailwind-merge
```
