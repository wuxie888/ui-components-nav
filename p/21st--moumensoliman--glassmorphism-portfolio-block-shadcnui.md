<!-- Glassmorphism Portfolio · @moumensoliman · https://21st.dev/@moumensoliman/components/glassmorphism-portfolio-block-shadcnui
...
```tsx
components/ui/glassmorphism-portfolio-block.tsx
"use client";
