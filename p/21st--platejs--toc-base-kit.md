<!-- TOC Base Kit · @platejs · https://21st.dev/@platejs/components/toc-base-kit
...
```tsx
components/editor/plugins/toc-base-kit.tsx
...
```bash
npm install @platejs/toc
```

Install shadcn/ui registry dependencies:
```bash
npx shadcn@latest add button toc-node.json
```
