<!-- Dropdown Menu · @preetsuthar17 · https://21st.dev/@preetsuthar17/components/dropdown-menu
...
```bash
npm install @radix-ui/react-dropdown-menu class-variance-authority lucide-react motion
```
