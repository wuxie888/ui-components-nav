<!-- Expandable Tabs · @preetsuthar17 · https://21st.dev/@preetsuthar17/components/expandable-tabs-1
...
```bash
npm install @radix-ui/react-tabs clsx framer-motion lucide-react tailwind-merge
```
