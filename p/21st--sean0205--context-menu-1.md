<!-- Context Menu · @sean0205 · https://21st.dev/@sean0205/components/context-menu-1
...
```tsx
components/ui/c-context-menu-10.tsx
...
```bash
npx shadcn@latest add button context-menu dialog
```
