<!-- Data Grid Table · @sean0205 · https://21st.dev/@sean0205/components/data-grid-table
     license: MIT · category: dashboard
     Here is Data Grid Table component -->
...
```bash
npm install @dnd-kit/core @dnd-kit/modifiers @dnd-kit/sortable @dnd-kit/utilities @tanstack/react-table class-variance-authority lucide-react
```

Install shadcn/ui registry dependencies:
```bash
npx shadcn@latest add avatar badge button card checkbox command data-grid dropdown-menu popover scroll-area select separator skeleton spinner
```
