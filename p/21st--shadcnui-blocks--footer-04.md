<!-- Footer 04 · @shadcnui-blocks · https://21st.dev/@shadcnui-blocks/components/footer-04
     license: no-license · category: footer
     A responsive website footer with logo, navigation links, a newsletter subscribe form, copyright, and social media icons. -->
