<!-- 8bit Game Progress · @theorcdev · https://21st.dev/@theorcdev/components/8bit-game-progress
...
export default function GameProgressDemo() {
  return (
    <div className="flex items-center justify-center w-full min-h-[400px] p-8 retro">
