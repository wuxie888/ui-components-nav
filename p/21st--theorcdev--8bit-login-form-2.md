<!-- 8-bit Login Form with Icons · @theorcdev · https://21st.dev/@theorcdev/components/8bit-login-form-2
...
```tsx
components/ui/8bit/blocks/login-form.tsx
...
```bash
npm install @radix-ui/react-label class-variance-authority radix-ui tailwindcss tw-animate-css
```
