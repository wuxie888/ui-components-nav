<!-- 8-bit Toggle · @theorcdev · https://21st.dev/@theorcdev/components/8bit-toggle
     license: MIT · category: toggle
     Pixel-art toggle button from 8bitcn.com — pressed state with retro pixel border. Wraps shadcn/ui Toggle. -->
  ...
  return (
    <div className="flex w-full min-h-screen items-center justify-center bg-background p-8 overflow-hidden">
      <div className="flex items-center gap-3">
        <Toggle aria-label="Bold" className="font-pixel">B</Toggle>
        <Toggle aria-label="Italic" defaultPressed className="font-pixel italic">I</Toggle>
        <Toggle aria-label="Underline" className="font-pixel underline">U</Toggle>
      </div>
    </div>
  );
}
