<!-- Corporate Clip Path Gallery · @uilayout.contact · https://21st.dev/@uilayout.contact/components/corporate-clippath
...
```tsx
components/ui/clip-path-corporate.tsx
...
demo.tsx
import ClipPathCorporate from '@/components/ui/corporate-clippath';

export default function DemoCorporateClipPath() {
  return (
