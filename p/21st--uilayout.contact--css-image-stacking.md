<!-- CSS Image Stacking · @uilayout.contact · https://21st.dev/@uilayout.contact/components/css-image-stacking
     license: MIT · category: gallery
     A scroll-driven stacking cards effect where images pile up using CSS sticky positioning and smooth scrolling. -->
...
```tsx
components/ui/css-image-stacking.txt
//
'use client';
