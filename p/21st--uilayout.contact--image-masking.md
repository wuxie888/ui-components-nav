<!-- Image Masking · @uilayout.contact · https://21st.dev/@uilayout.contact/components/image-masking
     license: unspecified · category: gallery
     Here is image masking component -->
...
```tsx
components/ui/creative-image-masking.tsx
...
demo.tsx
// demo.tsx
import Component from '@/components/ui/image-masking';
import React from 'react';

const ComponentDemo: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-gray-50 dark:bg-zinc-900 min-h-[500px]">
      <div className="w-full max-w-2xl border rounded-lg shadow-md p-6 bg-white dark:bg-black">
        ...
        <p className="mt-4 text-sm text-gray-600 dark:text-gray-400 text-center">
          This demo showcases the default appearance of the Clipped Splash Gallery.
        </p>
      </div>
    </div>
  );
