<!-- Mesh Gradient Background · @uilayout.contact · https://21st.dev/@uilayout.contact/components/mesh-gradient-background3
...
```tsx
components/ui/mesh-gradient-background3.txt
'use client';
...
demo.tsx
import MeshGradientBackground from '@/components/ui/mesh-gradient-background3';
...
```bash
npm install @react-three/drei @react-three/fiber @types/three three
```
