<!-- Sparkles Title · @uilayout.contact · https://21st.dev/@uilayout.contact/components/sparkles-title3
     license: no-license · category: hero
     A dark hero section with a headline, grid backdrop and an animated particle sparkles field along a glowing divider. -->
...
```tsx
components/ui/sparkles-title3.txt
