<!-- Vertical Thumbnail Slider · @uilayout.contact · https://21st.dev/@uilayout.contact/components/vertical-thumbnail-slider
     license: no-license · category: gallery
     An image carousel with a vertical thumbnail rail alongside the main slide for quick navigation between photos. -->
...
```tsx
components/ui/verticalthumbs-slider.tsx
'use client';
import {
  Carousel,
  Slider,
