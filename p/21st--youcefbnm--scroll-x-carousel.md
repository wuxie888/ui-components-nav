<!-- Scroll X Carousel · @youcefbnm · https://21st.dev/@youcefbnm/components/scroll-x-carousel
     license: unspecified · category: gallery
     - Carousel transforms on x direction according to current scroll position. -->
...
```bash
npx shadcn@latest add badge reveal-on-hover
```
