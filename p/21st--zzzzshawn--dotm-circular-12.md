<!-- Arc Beacon Dot Loader · @zzzzshawn · https://21st.dev/@zzzzshawn/components/dotm-circular-12
     license: custom proprietary license · category: spinner
     An animated dot-matrix loading spinner where a stepped beam sweeps around a circular grid with a dim opposite echo and diagonal spoke accents. -->
...
```tsx
components/ui/dotm-circular-12.tsx
"use client";
  ...
  return (
    <div className="flex min-h-[360px] w-full items-center justify-center bg-background text-foreground">
      <div className="flex flex-col items-center gap-6">
        <DotmCircular12 size={96} dotSize={11} />
