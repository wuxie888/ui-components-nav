<!-- Glyph Cycle · @zzzzshawn · https://21st.dev/@zzzzshawn/components/dotm-circular-20
     license: no-license · category: spinner
     Animated dot-matrix loader that cycles through distinct braille-like glyphs with previous-frame ghosting for a crisp, readable symbol transition. -->
...
```tsx
components/ui/dotm-circular-20.tsx
"use client";
