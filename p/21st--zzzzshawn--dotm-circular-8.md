<!-- Heart Pulse Loader · @zzzzshawn · https://21st.dev/@zzzzshawn/components/dotm-circular-8
     license: custom proprietary license · category: spinner
     A circular dot-matrix loading animation whose center pulses with a dual-beat heartbeat cadence, radiating soft concentric waves. -->
...
```tsx
components/ui/dotm-circular-8.tsx
"use client";
...
export default function Default() {
  return (
    <div className="flex min-h-[300px] w-full items-center justify-center bg-background text-foreground">
      <DotmCircular8 size={64} dotSize={8} />
    </div>
  );
}
```
