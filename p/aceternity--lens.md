<!-- Lens · Aceternity UI · https://ui.aceternity.com/components/lens
      ...
      <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-8 my-10">
        ...
        <div className="relative z-10">
          <Lens hovering={hovering} setHovering={setHovering}>
            <Image
              src="https://cdn.21st.dev/assets/mirror/0e/0ea1a6b7f59986a1118208d797eef30334da9e1c8594d5800166ffcd40446207.jpg"
              alt="image"
              width={500}
              height={500}
